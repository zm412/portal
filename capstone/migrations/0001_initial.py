# Generated by Django 3.2.6 on 2021-10-20 16:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_extensions', models.CharField(blank=True, max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='item_share', to='capstone.item')),
                ('likes_list_users', models.ManyToManyField(blank=True, null=True, related_name='likers_list', to=settings.AUTH_USER_MODEL)),
                ('solved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('item_for_comm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comm_item', to='capstone.item')),
